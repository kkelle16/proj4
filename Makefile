XX=k-check=full ./src/dijkstras < data/input1.txt 2		g++
CXXFLAGS=	-g -Wall -std=gnu++11
SHELL=		bash
PROGRAMS=	src/dijkstras generate_map

all:		src/dijkstras generate_map

dijkstras: src/dijkstras.cpp src/Node.h
	$(CXX) $(CXXFLAGS) -o $@ $^
